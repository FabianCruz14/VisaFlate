...
<body>
    ...
    <div class="inventario_container">
        <h1 name="papeles" style="color: #1115ee; font-weight: bold;">PAPELES</h1>
...
=======
            <tr id= "tabla_de_productos">
                <td><img class="img_table" src="images/hilos.jpg"></td>
                <td>Hilos de 3 Hebras</td>
                <td style="font-size: 30px;">$3</td>
                <td style="font-size: 30px;">20 </td>
...
>>>>>>> 485d970e552683752bf1e21c499cf623ef108ba7:hilos_productos.html
    </div>
