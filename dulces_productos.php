...
<body>
    ...
    <div class="inventario_container">
        <h1 name="dulces" style="color: #1115ee; font-weight: bold;">DULCES</h1>
...
=======
            <tr id= "tabla_de_productos">
                <td><img class="img_table" src="images/tijeras.jpg"></td>
                <td>Tijeras de ZIG-ZAG Marca:Pelican</td>
                <td style="font-size: 30px;">$17</td>
                <td style="font-size: 30px;">35 </td>
...
>>>>>>> 485d970e552683752bf1e21c499cf623ef108ba7:tijeras_productos.html
    </div>
